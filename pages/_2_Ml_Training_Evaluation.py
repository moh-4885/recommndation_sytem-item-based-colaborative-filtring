...
def collaborative_filtering_training(user_item_matrix):
    ...
    # # Add average user rating back to the predictions
   
    average_user_rating = pd.read_csv('user_means.csv')
    normalized_predicted_ratings += average_user_rating["0"].values.reshape(-1, 1)
